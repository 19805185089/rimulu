...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { key: "swallow", label: "吞噬", angle: -52 },
  { key: "pending", label: "待定", angle: -18 },
];

export const SKILL_FAN_ITEMS: SkillFanItem[] = [
  { key: "water", label: "水弹", offsetX: -46, offsetY: -86, delay: 0 },
  { key: "fire", label: "火焰球", offsetX: 46, offsetY: -86, delay: 28 },
];
